  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>ONLINE<em>MARKET</em></h2></a>
            ...
            <div class="header-text caption">
              ...
              <div id="search-section">
                ...
                <div class="searchText">
                  ...
                  <input type="text" name="q" class="searchText" placeholder="Enter your searching product Name here..." autocomplete="on">
                  </div>
